...
numOctal = oct(num)
if escolha == '1':
    print(f'A converão de {num} em Binario fica {Fore.LIGHTGREEN_EX}{numBin}')
elif escolha == '2':
    print(f'A conversão de {num} em Octadecimal fica {Fore.LIGHTRED_EX}{numOctal}')
else:
    print(f'A conversão de {num} para Hexadecimal fica {Fore.LIGHTBLUE_EX}{numHex}')
