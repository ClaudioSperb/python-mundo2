...
pagamento = int(input(f'Escolha a forma de pagamento digitando o numero correspondente: \n{Fore.LIGHTGREEN_EX}[0] - Pagamento a vista{Fore.RESET}\n{Fore.LIGHTCYAN_EX}[1] - A vista no Cartão{Fore.RESET}\n{Fore.LIGHTRED_EX}[2] - 3x no Cartão{Fore.RESET}\n{Fore.LIGHTYELLOW_EX}[3] - em até 2x Valor normal{Fore.RESET}\nDigite a opção desejada: '))
print('')
sleep(1.5)
if pagamento == 0:
